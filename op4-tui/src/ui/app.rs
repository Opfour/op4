...
pub fn run<B: ratatui::backend::Backend>(
    ...
    loop {
        ...
        terminal
            ...
            .map_err(|e| op4_core::error::AppError::Io(std::io::Error::other(e.to_string())))?;
...
fn send_bundle_request(
    ...
    let wire = WireMessage {
        ...
        header: op4_core::crypto::ratchet::MessageHeader {
            dh_pub: [0u8; 32],
            pn: 0,
            n: 0,
        },
        ciphertext: payload,
        mac: op4_core::crypto::hmac_auth::MessageMac { tag: [0u8; 32] },
    };
